...
export function handleDistributorCreated(event: DistributorCreated): void {
  ...
  entity.padAddress = event.params.padAddress
  entity.padIndex = event.params.padIndex
  ...
  // - contract.distributorsCount(...)
  // - contract.getDistributorAddress(...)
  // - contract.owner(...)
  // - contract.template(...)
}
